...
ssh -t 'root@10.228.10.7' 'ssh-keygen -R agl-user@'$ip''
...
SSH_EOF
ssh -t 'root@10.228.10.7' 'cd chef-repo && knife bootstrap '$ip' -N '$ip' -x agl-user -P AGL@12345678 --sudo --run-list recipe[COOKBOOK::installagents]'
