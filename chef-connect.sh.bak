...
## ssh -t 'root@10.228.10.7' 'sshpass -p AGL@12345678 ssh-copy-id agl-user@'$ip''
...
# SSH_EOF
ssh -t 'root@10.228.10.7' 'cd chef-repo && knife bootstrap '$ip' -N '$ip' -x '$username' -P '$password' --sudo --run-list recipe[installagents]'
